...
function cr() {
  if (Oe)
    return A;
  Oe = 1;
  var w = Ce, P = Symbol.for("react.element"), U = Symbol.for("react.fragment"), m = Object.prototype.hasOwnProperty, I = w.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, W = { key: !0, ref: !0, __self: !0, __source: !0 };
  function j(h, c, T) {
    var p, b = {}, E = null, $ = null;
...
function dr() {
  return Se || (Se = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function We(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === m || e === W || Ie || e === I || e === T || e === p || Fe || e === $ || ke || De || Ae || typeof e == "object" && e !== null && (e.$$typeof === E || e.$$typeof === b || e.$$typeof === j || e.$$typeof === h || e.$$typeof === c || // This needs to include all possible module reference object
...
var we = Z.exports;
const vr = ({ message: w }) => /* @__PURE__ */ we.jsx("div", { children: w });
function pr() {
  return /* @__PURE__ */ we.jsx(vr, { message: "Hello, World!" });
}
defineWebComponent("app-root", pr);
